  ...
  return (
    <FormCard>
      <div className='lg:px-36 mx-auto text-center text-white'>
        <h1 className='text-3xl font-bold'>Experience unforgettable travel memories on bus, train, or transport!</h1>
        <p className='text-xl font-bold'>Discover unbeatable deals on Transportation.</p>
      </div>
      <form
      ...
      >
        <div className='flex flex-col justify-center w-full md:w-auto'>
          <label htmlFor='pickup' className='font-bold text-lg ml-1 text-blue-950'>
            Pick-up
          </label>
          <input
            type='text'
        ...
        <div className='flex flex-col justify-center w-full md:w-auto '>
          <label htmlFor='drop' className='font-bold text-lg ml-1 text-blue-950'>
            Drop
          </label>
          <input
            type='text'
