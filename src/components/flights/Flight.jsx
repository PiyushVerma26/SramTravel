    ...
    <>
      <FormCard>
        <div className='lg:px-36 mx-auto text-center text-white'>
          <h1 className='text-3xl font-bold'>Start an unforgettable journey, let's make lasting sky memories.</h1>
          <p className='text-xl font-bold'>Unlock unbeatable flight deals and beyond your expectations.</p>
        </div>
        <form
        ...
        >
          <div className='flex flex-col justify-center w-full md:w-auto'>
            <label htmlFor='from' className='font-bold text-lg ml-1 text-blue-950'>
              Where From
            </label>
            <input
              type='text'
          ...
          <div className='flex flex-col justify-center w-full md:w-auto '>
            <label htmlFor='to' className='font-bold text-lg ml-1 text-blue-950'>
              Where To
            </label>
            <input
              type='text'
          ...
          <div className='flex flex-col justify-center  w-full md:w-auto  '>
            <label htmlFor='date' className='font-bold text-lg ml-1 text-blue-950'>
              Date
            </label>
            <input
              type='date'
          ...
          <div className='flex flex-col justify-center w-full md:w-56'>
            <label htmlFor='TotalPassenger' className='font-bold text-lg ml-1 text-blue-950'>
              Total Passenger
            </label>
            <select
              id='totalPassenger'
