...
function Trending() {
  return (
    <div className='md:px-4 mx-auto max-w-7xl'>
      ...
      <ItemCard>
        <TrendingCard img={india} title='India' link='https://www.google.com/' />
        <TrendingCard img={london} title='London' link='https://www.google.com/' />
        <TrendingCard img={us} title='America' link='https://www.google.com/' />
        <TrendingCard img={germany} title='Germany' link='https://www.google.com/' />
        <TrendingCard img={france} title='France' link='https://www.google.com/' />
        <TrendingCard img={maldives} title='Maldives' link='https://www.google.com/' />
      </ItemCard>
    </div>
  )
}
