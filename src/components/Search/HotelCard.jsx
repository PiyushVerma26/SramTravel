...
function HotelCard() {
  ...
  return (
    <div className='relative'>
      {filterToggle && (
        <div style={{ zIndex: '50' }} className='h-screen w-screen overflow-auto fixed inset-0 bg-white'>
          <div className='relative'>
            <Filter />
            <RxCross2
            ...
            data.map((item) => (
              <HotelBook key={item.id}>
                <div className='flex md:flex-row flex-col gap-2'>
                  <img src={us} className='md:w-[40%] md:h-full w-full h-[50%] rounded-xl' />
                  <div className='w-full'>
                    <div className='flex md:flex-row flex-col md:justify-between md:items-center px-2 w-full flex-grow-1'>
                      <h1 className='text-blue-600 font-bold md:text-2xl text-lg'>The Taj Hotel Mumbai</h1>
                    ...
                    <p className='text-blue-800 px-3'>
                      Mumbai India <span className='text-black'>1 km away from marine drive</span>
                    </p>
                    <p className='px-3'>
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore saepe laudantium beatae atque
                      aliquid asperiores consectetur corrupti totam libero natus unde quidem excepturi perspiciatis
                      voluptate, minima molestias eum officiis expedita.
                    </p>
                  </div>
                </div>
